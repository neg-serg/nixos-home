...
- 2025-11: `Components/CapsuleButton.qml` wraps `WidgetCapsule` with built-in pointer handlers; prefer it (directly or via `CenteredCapsuleRow`) for кликабельные капсулы вроде часов, погоды, индикатора раскладки.
