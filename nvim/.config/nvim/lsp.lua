...
local function on_attach(client, bufnr)
  ...
  buf_keymap('n', '<leader>dn', '<cmd>lua vim.lsp.diagnostic.jump({count=1, float=true})<cr>', opts)
  buf_keymap('n', '<leader>dp', '<cmd>lua vim.lsp.diagnostic.jump({count=-1, float=true})<cr>', opts)
