{ config, pkgs, ... }: {
    programs.beets = {
        ...
        settings = {
            plugins = ["bpm" "chroma" "duplicates" "edit" "embedart" "export"
                "fetchart" "fromfilename" "ftintitle" "fuzzy" "info"
                "lastgenre" "lastimport" "lyrics" "mbcollection" "mbsubmit"
                "mbsync" "mpdstats" "web"];
                # "discogs"
            ...
            chroma = { auto = "yes"; };
            lastgenre = { auto = true; canonical = true; count = 5; };
